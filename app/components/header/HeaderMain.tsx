...
const HeaderMain = () => {
    ...
    const menuMobileModal = (
        <div className="modal-mobile mt-10 text-center flex flex-col justify-start items-center gap-6  md:hidden">
    ...
    return (
        <header className="relative flex flex-wrap md:justify-start md:flex-nowrap z-50 w-full bg-white text-sm py-3 md:py-0">
            <nav className="page-width w-full mx-auto px-4 md:px-10" aria-label="Menu Main">
                <div className="gap-2 md:py-1.5 md:gap-4 lg:gap-18 xl:gap-24  md:flex md:items-center md:justify-between">
                    <div className="flex items-center justify-between md:block ">
                        ...
                        <div className="flex items-center justify-center gap-5">
                            <a className="text-white md:hidden" href="/">
                    ...
                    <div id="navbar-collapse-with-animation" className="hs-collapse fixed px-4 w-full left-0 bg-white max-w-full md:max-w-[92%] hidden flex-1 transition-all duration-75 md:block md:static">
                        <div className="overflow-auto md:overflow-hidden max-h-[80vh]">
                            <div className="flex flex-col  gap-x-0 md:flex-row md:items-center md:justify-around md:gap-x-7 md:mt-0 ">
                    ...
                    <div className="flex flex-col items-center justify-between md:flex-row">
                        <a className="text-white p-3 hidden md:block" href="/">
